...
plugin_identifier = "filament_runout_for_orangepipc"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_filament_runout_for_orangepipc"
...
plugin_author = "NandoGommez"

# The plugin's author's mail address.
plugin_author_email = "fernandogommez1@gmail.com"

# The plugin's homepage URL. Can be overwritten within OctoPrint's internal data via __plugin_url__ in the plugin module
plugin_url = "https://github.com/NandoGommez/Octoprint_FilamentSensor_for_OrangePiPc"
